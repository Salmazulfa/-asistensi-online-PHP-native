...
<html lang="en">
  ...
  <body>
    ...
    <div class="kotak1 mt-3">
      <h4 style="color: #F4F9F8">DATA DOSEN</h4></a><hr class="bg-dark">
      <b><h6><a href="add_dosen.php" style="color: #13405C"><i class="fas fa-plus-circle"></i> Add new dosen</a></h6></b>
          ...
          <table class="table table-secondary table-striped">
            <thead>
              <tr>
                ...
                <th scope="col">Pengampu Mata Kuliah</th>
            ...
            <tbody>
             <?php
              $no=1;
              include 'koneksi.php';
             $a = "SELECT * FROM user INNER JOIN dosen ON user.username=dosen.username2 INNER JOIN matkul ON dosen.id_matkul = matkul.id_matkul ORDER BY username2 ASC";
              $b = $koneksi->query($a);
              while ($c=$b->fetch_array()) { ?>
                  <tr>
                    <td><?php echo $c['username2']; ?></td>
                    <td><?php echo $c['password']; ?></td>
                    <td><?php echo $c['nm_dosen']; ?></td>
                    <td><?php echo $c['tempat_lahir'].", ".$c['tgl_lahir']; ?></td>
                    <td><?php echo $c['jenis_kelamin']; ?></td>
                    <td><?php echo $c['email']; ?></td>
                    <td><?php echo $c['alamat']; ?></td>
                    <td><?php echo $c['nm_matkul']; ?></td>
                    <center><td><a href="edit_datadosen.php?username=<?php echo $c['username']; ?> "><i class="far fa-edit" style="color: #40A2AE"></i>Edit</a><br>
                      <a class="delete" href="delete_dosen.php?username=<?php echo $c['username']; ?> " onClick="return confirm('Apakah Anda Ingin Menghapus Data?')"><i class="fas fa-trash" style="color: #40A2AE"></i> Delete</a>
                    </center>
                  </tr>
            <?php } ?>
            </tbody>
