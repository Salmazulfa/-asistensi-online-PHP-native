...
<html lang="en">
  <head>
    ...
    <title>Add New Account (Dosen)</title>
  </head>
  <body style="background-image: animasi praktikum1.jpg">
    ...
    <!-- <div class="navigasi"> -->
    <!-- <section> -->
    <form class="kotak12 needs-validation" action="aksi_adddosen.php?op=in" method="POST">
    <br><h5 style="color: #F4F9F8">Add New Account (Dosen)</h5></a><hr class="bg-dark">
    <div class="add_kiri">
      <div class="col-md-4">
      ...
      <div class="col-md-4">
        ...
        <input type="text" class="form-control" style="width: 43vh;" id="validationCustom01" required name="nm_dosen">
      </div>
      <div class="col-md-4">
      ...
      <br><a href="data_dosen.php"><i class="fas fa-arrow-circle-left fa-3x mt-3 mb-3" style="color: #235F5B"></i></a>
    </div>

    <div class="add_kanan">
      <div class="col-md mt-2">
        <br><div class="dropdown">
            <select class="btn btn-#235F5B dropdown-toggle text-white" style="width: 43vh;" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false" style="color: #235F5B; width: 45vh;" name="level">
        ...
        <label for="validationServer02" class="form-label mt-1">Pengampu Mata Kuliah</label>
        <select class="form-select" style="width: 43vh;" aria-label="Default select example" name="matkul">
          <option class="matkul" value="" selected>Pilih</option>
          <?php
             include 'koneksi.php';
      ...
      <div class="col-md-4">
        ...
        <input type="text" class="form-control" style="width: 43vh;" id="validationServer02" name="tempat_lahir" required>
      </div>
      <div class="col-md-4">
      ...
      <br><div class="col-12">
        <button class="btn btn-primary" type="submit" style="width: 40vh;">Add New Account</button>
      </div>
    </div>
    </form>
