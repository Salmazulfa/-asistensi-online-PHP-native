          ...
          <table class="table table-secondary table-striped">
            <thead>
              <tr>
                ...
                <th scope="col">Nama Asisten Lab.</th>
            ...
            <tbody>
             <?php
              $no=1;
              include 'koneksi.php';
              $a = "SELECT * FROM penilaian, nilai_akhir where penilaian.id_prak = nilai_akhir.id_prak";
              $b = $koneksi->query($a);
              while ($c=$b->fetch_array()) { ?>
                  <tr>
                    <!-- <td><?php echo $c['username']; ?></td> -->
                    <!-- <td><?php echo $c['nm_mhs']; ?></td> -->
                    <td><?php echo $c['nilai_prak']; ?></td>
                    <td><?php echo $c['nilai_tot']; ?></td>
                    <!-- <td><?php echo $c['nm_aslab']; ?></td> -->
                    <td><a href="delete.php?id=<?php echo $c['id']; ?> ">delete</a> ||
