...
<html lang="en">
  ...
  <body style="background-image: animasi praktikum1.jpg">
    ...
    <?php
      $tampil =mysqli_query($koneksi,"SELECT * FROM dosen INNER JOIN matkul ON dosen.id_matkul=matkul.id_matkul AND username2='$username'");
    ...
    ?>
    <section>
    <form class="form_add g-3 needs-validation" action="aksi_editdosen.php?op=in" method="POST">
    <center><h4 style="color: #F4F9F8">EDIT DATA</h4></a><hr class="bg-dark"></center>
    <div class="add_kiri">
      <div class="col-md-4">
      ...
      <div class="col-md-4">
        ...
        <input type="text" class="form-control" style="width: 41vh;" id="validationCustom01" required name="nm_dosen" value="<?=$aa['nm_dosen']?>">
      </div>
      <div class="col-md-4">
      ...
      <a href="data_dosen.php"><i class="fas fa-arrow-circle-left fa-3x mt-3 mb-3" style="color: #235F5B"></i></a>
    </div>

    <div class="add_kanan">
      <br><div class="dropdown">
          <select class="btn btn-#235F5B dropdown-toggle text-white" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false" style="color: #235F5B" name="level">
      ...
      <div class="col-md mt-2">
        <label for="validationServer02" class="form-label" style="width: 41vh;">Pengampu Mata Kuliah</label>
        <select class="form-select" aria-label="Default select example" name="matkul">
          <option class="matkul" value="<?=$aa['id_matkul']?>" selected><?=$aa['nm_matkul']?></option>
          <?php
             include 'koneksi.php';
      ...
      <div class="col-md-4 mt-3">
        ...
        <table><tr><td>
          <div class="form-check">
            <input class="form-check-input" type="radio" name="jenis_kelamin" id="flexRadioDefault1" value="Laki-Laki" <?php if($aa['jenis_kelamin']=='Laki-Laki') echo 'checked'?>>
