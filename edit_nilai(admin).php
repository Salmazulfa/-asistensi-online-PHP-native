...
<html lang="en">
  ...
  <body>
    ...
    <div class="kotak3 mt-3">
      ...
      <div class="upload">
        <form  method="post" enctype="multipart/form-data" action="aksi_nilai(admin).php">
          <div class="col-md">
          ...
          <div class="col-md-2">
            ...
            <a href="nilai_mhs.php"><i class="fas fa-arrow-circle-left fa-3x mt-2 mb-3" style="color: #235F5B"></i></a>
          </div>
        </form>
      </div>
    </div>
