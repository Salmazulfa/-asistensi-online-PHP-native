...
<html lang="en">
  ...
  <body>
    ...
    <div class="kotak1 mt-3">
      <h4 style="color: #F4F9F8">DATA MAHASISWA</h4></a><hr class="bg-dark">
      <h6><a href="add_mhs.php" style="color: #13405C"><i class="fas fa-plus-circle"></i> Add new student</a></h6>
        <div class="tabel_dosen">
          ...
          <table class="table table-secondary table-striped">
            ...
            <tbody>
              ...
              $no=1;
              include 'koneksi.php';
              $a = "SELECT * FROM user INNER JOIN mhs ON user.username=mhs.username4 ORDER BY username4 ASC";
              $b = $koneksi->query($a);
              ...
              while ($c=$b->fetch_array()) { ?>
                  <tr>
                    ...
                    <center><td><a href="edit_datamhs.php?username=<?php echo $c['username']; ?> "><i class="far fa-edit" style="color: #40A2AE"></i>Edit</a><br>
                      <a class="delete" href="delete_mhs.php?username=<?php echo $c['username']; ?> " onClick="return confirm('Apakah Anda Ingin Menghapus Data?')"><i class="fas fa-trash" style="color: #40A2AE"></i> Delete</a>
                    </center>
                  </tr>
                  <?php
                }  
