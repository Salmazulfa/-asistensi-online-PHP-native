...
<html lang="en">
  ...
  <body>
    <nav class="navbar">
      <div class="container">
        <img src="logo asline.png" alt="AsLine" width="70" height="60">
    ...
    <div class="kotak1 mt-3">
      <h4 style="color: #F4F9F8">DATA NILAI</h4></a><hr class="bg-dark">
        <div class="tabel_dosen">
          ...
          <table class="table table-secondary table-striped">
            ...
            <tbody>
             <?php
              $no=1;
              $a = "SELECT * FROM file_laporan INNER JOIN praktikum ON file_laporan.prakke=praktikum.id_prak INNER JOIN mhs ON file_laporan.id_mhs=mhs.id_mhs INNER JOIN aslab ON aslab.id_aslab=file_laporan.id_aslab INNER JOIN presensi ON file_laporan.id_presensi=presensi.id_presensi INNER JOIN matkul ON file_laporan.kode_matkul=matkul.id_matkul order by nm_aslab asc";
              $b = $koneksi->query($a);
              while ($c=$b->fetch_array()) { ?>
                  <tr>
                    ...
                    <center><td><a href="edit_nilai(admin).php?id_laporan=<?php echo $c['id_laporan']; ?> "><i class="far fa-edit" style="color: #40A2AE"></i>Edit</a></td>
                    </center>
                  </tr>
            <?php } ?>
            </tbody>
