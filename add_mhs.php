...
<html lang="en">
  ...
  <body style="background-image: animasi praktikum1.jpg">
    ...
    <!-- <section> -->
    <form class="kotak12 needs-validation" action="aksisave_mhs.php?op=in" method="POST">
    <br><h5 style="color: #F4F9F8">Add New Account (Mahasiswa)</h5></a><hr class="bg-dark">
    <div class="add_kiri">
      <div class="col-md-4">
        <label for="validationCustom01" class="form-label">Username</label>
        <input type="text" class="form-control" style="width: 41vh;" id="validationCustom01" required name="username">
      </div>
      <div class="col-md-4">
        <label for="validationCustom01" class="form-label">Password</label>
        <input type="password" class="form-control" style="width: 41vh;" id="validationCustom01" required name="password">
      </div>
      <div class="col-md-4">
        <label for="validationCustom01" class="form-label" style="width: 41vh;">Nama Lengkap</label>
        <input type="text" class="form-control" style="width: 41vh;" id="validationCustom01" required name="nm_mhs">
      </div>
      <div class="col-md-4">
        <label for="validationCustom01" class="form-label">Email</label>
        <input type="email" class="form-control" style="width: 41vh;" id="validationCustom01" required name="email">
      </div>
       <div class="col-md-4">
        <label for="validationCustom01" class="form-label">Alamat</label>
        <input type="text" class="form-control" style="width: 41vh;" id="validationCustom01" required name="alamat">
      </div>
      <a href="data_mhs.php"><i class="fas fa-arrow-circle-left fa-3x mt-3 mb-3" style="color: #235F5B"></i></a>
    </div>

    <div class="add_kanan mt-4">
