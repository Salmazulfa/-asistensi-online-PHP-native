  ...
  <div class="kotak3 mt-3">
      ...
      <div class="upload">
        <form  method="post" enctype="multipart/form-data">
          <div class="col-md">
            <input type="text" class="form-control" id="validationServer01" required name="id_mhs" value="<?=$aa['id_mhs']?>">
            <input type="text" class="form-control" id="validationServer01" name="id_tugas" required value="<?=$bb['id_tugas']?>">
        ...
        <div class="col-md-4 mt-2">
          ...
          <select class="form-select col-md-4" aria-label="Default select example" name="id_matkul" required>
        ...
        <div class="col-md-3 mt-2">
          <button class="btn btn-primary" type="submit" name="upload">Upload</button><br>
          <br><input class="btn btn-primary mb-5" type="button" value="Back" onclick="history.back(-1)" />
        </div>
        </form>
        ...
        if (!empty($_FILES["myFile"])) {
          ...
          if (!$success){ 
            ...
            $insert = $koneksi->query("INSERT INTO file_laporan (id_mhs, id_tugas, kode_matkul, id_presensi, id_aslab, tgl, nm_file, size_file, tipe_file, prakke, komentar, nilai) values ('$id_mhs', '$id_tugas', '$id_matkul', '$id_presensi', '$aslab', '$tgl', '$name', '$ukuran', '$ext', '$prak', '$komen', '$nilai)");
            if($insert){
              ?>
