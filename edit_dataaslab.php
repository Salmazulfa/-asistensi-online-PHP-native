...
<html lang="en">
  ...
  <body style="background-image: animasi praktikum1.jpg">
    ...
    ?>
    <section>
    <form class="form_add g-3 needs-validation" action="aksi_editaslab.php?op=in" method="POST">
    <center><h5 style="color: #F4F9F8">Edit Data (Asisten Praktikum)</h5></a><hr class="bg-dark"></center>
    <div class="add_kiri">
      <div class="col-md-4">
      ...
      <div class="col-md-4">
        ...
        <input type="text" class="form-control" style="width: 41vh;" id="validationCustom01" required name="nm_aslab" value="<?=$aa['nm_aslab']?>">
      </div>
      <div class="col-md-4">
       ...
       <div class="col-md-4">
        <label for="validationCustom01" class="form-label" style="width: 41vh;">Alamat</label>
    ...
    <div class="add_kanan">
      ...
      <div class="col-md-4 mt-2">
        <label for="validationServer02" class="form-label" style="width: 41vh;">Mata Kuliah/Kelas</label>
        <select class="form-select col-md-4" style="width: 41vh;" aria-label="Default select example" name="matkul">
          <option class="col-md-7" value="<?=$aa['Id_matkull'];?>"><?php echo $aa['nm_matkul']?></option>
          <?php
             include 'koneksi.php';
