...
<html lang="en">
  ...
  <div class="container_tugas">
    <div class="tugas">
      <center><h4>Jaringan Komputer</h4></center><br>
    <?php
    include "koneksi.php";
    ...
    ?>
      <table class="table table-secondary table-striped">
        ...
        <tbody>
          ...
          $no=1;
          include 'koneksi.php';
          $a = "SELECT * FROM file_tugas INNER JOIN dosen ON file_tugas.id_dosen=dosen.id_dosen where id_matkul='2'";
          $b = $koneksi->query($a);
          ...
          <tr>
            ...
            if (empty($c['nm_file'])) {
              echo "No completed";
            }else if (!empty($c['nm_file'])) {
              echo "Completed";
            }
            ?></td> -->
            <td><a href="coba_kerjakan.php?id_tugas=<?php echo $c['id_tugas']; ?>"><i class="fas fa-edit" style="color: #40A2AE"></i> Kerjakan</a><br>
                <a href="uploads/<?php echo $c['nm_file']; ?>" ><i class="fas fa-download" style="color: #40A2AE"></i> Download</a>
            </td>
          </tr>
          <?php } ?>
        </tbody>
