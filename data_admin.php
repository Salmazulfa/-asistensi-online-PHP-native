...
<html lang="en">
  ...
  <body>
    ...
    <div class="kotak">
      <!-- <div class="col-md-2 bg-light"> -->
        <ul class="nav flex-column ml-3 mb-3 bg-light">
          ...
          <li class="nav-item">
            <a class="nav-link text-white mt" href="data_admin.php"><i class="fas fa-users-cog"></i>  Data Admin</a><hr class="bg-light">
          </li>
          <li class="nav-item">
    ...
    <div class="kotak1 mt-3">
      ...
      <h6><a href="add_new.php" style="color: #13405C"><i class="fas fa-plus-circle"></i> Add new admin</a></h6>
          <!-- On tables -->
          <table class="table table-secondary table-striped">
            ...
            <tbody>
              ...
              $no=1;
              include 'koneksi.php';
              $a = "SELECT * FROM user INNER JOIN admin ON user.username=admin.username1 ORDER BY username1 ASC";
              $b = $koneksi->query($a);
              while ($c=$b->fetch_array()) { ?>
                  <tr>
                    <td><?php echo $c['username1']; ?></td>
                    <td><?php echo $c['password']; ?></td>
                    <td><?php echo $c['nm_admin']; ?></td>
                    <td><?php echo $c['email_admin']; ?></td>
                    <center><td><a href="edit_akun.php?username=<?php echo $c['username']; ?>"><i class="far fa-edit" style="color: #40A2AE"></i>Edit</a> || 
                      <!-- <a href="delete_admin.php?username=<?php echo $c['username']; ?> "><i class="fas fa-trash" style="color: #40A2AE"></i>Delete</a> -->
                      <a href="delete_admin.php?username=<?php echo $c['username'];?>" onClick="return confirm('Apakah Anda benar-benar mau menghapusnya?')"><i class="fas fa-trash" style="color: #40A2AE"></i>Delete</a>     
                      </td>
                    </center>
                  </tr>
                  <?php
