...
<!--         <a href="profil_mhs.php"><i class="fas fa-user-circle fa-2x" style="color: #40A2AE"></i></a> -->
        <!-- <a href="logout.php"><i class="fas fa-sign-out-alt fa-2x" style="color: #40A2AE"></i></a> -->
        <a class="logout" href="logout.php" onClick="return confirm('Apakah Anda Ingin Keluar?')"><i class="fas fa-sign-out-alt fa-2x" style="color: #40A2AE"></i></a>
      </div>
    </nav>
  ...
  <div class="container_tugas">
    <div class="tugas">
      <center><h4>Pemrograman Web</h4></center><br>
    <?php
    include "koneksi.php";
    ...
    ?>
      <table class="table table-secondary table-striped">
        ...
        <tbody>
          ...
          $no=1;
          include 'koneksi.php';
          $a = "SELECT * FROM file_tugas INNER JOIN dosen ON file_tugas.id_dosen=dosen.id_dosen where id_matkul='1'";
          $b = $koneksi->query($a);
          while ($c=$b->fetch_array()) { ?>
          <tr>
            <td><?php echo $c['prak']; ?></td>
