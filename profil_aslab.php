...
<html lang="en">
  ...
  <body>
            ...
            <nav class="navbar1 navbar-expand">
                <div class="collapse navbar-collapse" id="navbarNav">
                  <ul class="navbar-nav">
                    ...
                    <li class="nav-item1">
                      <a class="nav-link text-white" href="profil_aslab.php">Profile</a>
                    </li>
                  </ul>
                </div>
            </nav>
    ...
    ?>
    <form class="kotak3 g-3 mt-3 mb-10" method="POST" action="edit_profilaslab.php">
      <h4 style="color: #F4F9F8"><i class="fas fa-user-alt"></i>  PROFIL - <?php echo $_SESSION['username'] ?></h4><hr class="bg-dark">
      <div class="add_kiri">
      <div class="col-md-4">
        <label for="validationServer01" class="form-label mt-1" style="width: 43vh;">NIM (Username)</label>
      ...
      <div class="col-md-4 mt-2">
        ...
        <input type="text" class="form-control" style="width: 43vh;" id="validationServer01" required name="nm_aslab" value="<?=$aa['nm_aslab']?>">
      </div>
      <div class="col-md-4 mt-2" style="width: 43vh;">
        <label for="validationServerUsername" class="form-label" >Email</label>
        <div class="input-group has-validation">
          <span class="input-group-text" id="inputGroupPrepend3">@</span>
          <input type="text" class="form-control" id="validationServerUsername" aria-describedby="inputGroupPrepend3 validationServerUsernameFeedback" name="email" value="<?=$aa['email']?>">
        </div>
      </div>
      ...
      <div class="col-md-3 mt-15">
        <br><button class="btn btn-primary" style="width: 35vh;" type="submit">Edit</button>
      </div>
      </div>
    </form>
