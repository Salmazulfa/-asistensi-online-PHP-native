...
<html lang="en">
  ...
  <body>
    ...
    ?>
    <form class="kotak3 g-3 mt-3" method="POST" action="edit_profilmhs.php">
      ...
      <div class="col-md-4 mt-2">
        ...
        <input type="text" class="form-control" style="width: 43vh;" id="validationServer01" required name="nm_mhs" value="<?=$aa['nm_mhs']?>">
      </div>
